...
{
  \inst{1}%
 University of Torino, Italy, Retired Professor, \href{https://terna.to.it}{https://terna.to.it}, \href{mailto:pietro.terna@unito.it}{pietro.terna@unito.it}
  \and
 \inst{2}%
  Fondazione Collegio Carlo Alberto, Italy, Honorary Fellow
  }
% - Use the \inst command only if there are several affiliations.
% - Keep it simple, no one is interested in your street address.

\date[] % (optional, should be abbreviation of conference name)
{\href{https://sites.google.com/view/lucadacci/urban-science}{Maths of Cities}---January \nth{20}, 2022
...
\includegraphics[width=0.08\textwidth]{logo2_unito.png}~~~~~~\includegraphics[width=0.08\textwidth]{CCA_Logo2.png}
...
\begin{figure}[H]
\center
\includegraphics[scale=0.27]{abm.png}
\label{abmPicture}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Many tools and a scheme}
...
\center
\fbox{
\includegraphics[width=9cm]{scheme1.png} %s[width=15cm,height=6cm]scale=0.26
}
\label{scheme}
\end{figure}
...
\center
\fbox{
\includegraphics[width=9cm]{scheme2.png} %s[width=15cm,height=6cm]scale=0.26
}
\label{scheme}
\end{figure}
...
\center
\fbox{
\includegraphics[width=9cm]{scheme3.png} %s[width=15cm,height=6cm]scale=0.26
}
\label{scheme}
\end{figure}
...
\center
\fbox{
\includegraphics[width=9cm]{scheme4.png} %s[width=15cm,height=6cm]scale=0.26
}
\label{scheme}
\end{figure}
...
\center
\fbox{
\includegraphics[width=9cm]{scheme5.png} %s[width=15cm,height=6cm]scale=0.26
}
\label{scheme}
\end{figure}
...
\item 
We use NetLogo (\href{https://ccl.northwestern.edu/netlogo/}{https://arxiv.org/abs/2108.08885}).
...
\item
 A paper is published at \href{https://arxiv.org/abs/2108.08885}{https://terna.to.it/simul/SIsaR.html}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Updated series, with a third wave (data until the middle of January 2022)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{To recap (2020 waves)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{2021: planning a vaccination campaign using GAs (with non-pharmaceutical containment measures in action)}
