...
\item In our case we have to decide how to assign vaccinations over time to the seven groups of persons.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{How we organize the parameters (an example)}
